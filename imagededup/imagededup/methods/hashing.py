...
class Hashing:
    ...
    def encode_images(self, image_dir=None):
        ...
        #print(f'Start: Calculating hashes...', end='\n', flush=True)
        result = self.send_data.send('pHashing', message='Start: Calculating hashes...')
        ...
        #print(f'End: Calculating hashes!', end='\n', flush=True)
        result = self.send_data.send('pHashing', message='End: Calculating hashes...')
    ...
    def _find_duplicates_dict(
        ...
        result = self.send_data.send('pHashing', message='Start: Evaluating hamming distances for getting duplicates')
        ...
        result = self.send_data.send('pHashing', message='End: Evaluating hamming distances for getting duplicates')
