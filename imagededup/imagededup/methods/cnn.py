...
class CNN:
    ...
    def _build_model(self):
        ...
        #print('Initialized: MobileNet pretrained on ImageNet dataset sliced at last conv layer and added '
        #      'GlobalAveragePooling')
        result = self.send_data.send('CNN', message='Initialized: MobileNet pretrained on ImageNet dataset')
        result = self.send_progress.send('CNN', percent=20)
    ...
    def _get_cnn_features_batch(self, image_dir: PosixPath) -> Dict[str, np.ndarray]:
        ...
        """
        #print('Start: Image encoding generation')
        result = self.send_data.send('CNN', message='Start: Image encoding generation')
        result = self.send_progress.send('CNN', percent=40)
        ...
        #print('End: Image encoding generation')
        result = self.send_data.send('CNN', message='End: Image encoding generation')
        result = self.send_progress.send('CNN', percent=60)
    ...
    def _find_duplicates_dict(
        ...
        result = self.send_data.send('CNN', message='Start: Calculating cosine similarities')
        result = self.send_progress.send('CNN', percent=80)
        ...
        result = self.send_data.send('CNN', message='End: Calculating cosine similarities')
        result = self.send_progress.send('CNN', percent=90)
        ...
        result = self.send_data.send('CNN', message='Finished')
        result = self.send_progress.send('CNN', percent=100)
